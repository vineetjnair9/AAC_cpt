...
VOT_walking = price/walk_time
VOT_waiting = price/wait_time
VOT_drive = price/drive_time
VOT_transit = price/transit_time
VOT_exc = price/exc_time
VOT_pool = price/pool_time
...
for i = 1:num_responses
    ...
    % Calculate static self-reference for each passenger based on average
    % price & travel time with SMoDS
