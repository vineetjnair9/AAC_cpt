...
% Using simplified calculation of probability weights - similar to Singapore AVs paper
clear; clc;
...
panel = @(x,respondent_num) panel_obj(x,respondent_num,table,'dynamic_SMoDS','modified',paramhat);
