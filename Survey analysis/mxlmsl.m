...
disp 'Mixed logit with 100 MLHS draws: 3 lognormal, 2 normal, 2 fixed.'
...
NAMES={'price';'opcost';'range';'ev';'hybrid'}; 
...
% Here - using gas vehicle as reference/baseline alternative?
% Setting constant term (ASC) for that = 0
