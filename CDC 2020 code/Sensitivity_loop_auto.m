%% Sensitivity analysis loop code
clear;
clc;

%% Nominal CPT parameter values 
% 20 random scenarios (from CDC paper)
% alpha = 0.895;
% beta = 0.88;
% lambda = 2.25;
% p = 0.7;
...
%% Make and save plots
load('C:\Users\vinee\Dropbox\CDC 2020_Vineet and Yue\CDC_2020_Results\Test_10RandomScenarios_within_param_bounds.mat')
num_scenarios = 10;
...
for i = 1:num_scenarios
    ...
    directory = 'C:\Users\vinee\Dropbox\CDC 2020_Vineet and Yue\CDC_2020_Results\Test_10RandomScenarios_within_param_bounds';
...
%% Find error between numerical and analytical for more general scenarios as well
